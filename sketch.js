var ground,groundImage,player,diamond,diamondImage, diamondsGroup,score = 0,invisibleground,laserbeam, laserImage, laserbeamGroup,life=10,blank1,blank2, blank1Image,blank2Image,strawberry,strawberryImage, strawberryGroup, collider, colliderGroup;
var PLAY = 1;
var END = 0;
var gameState = PLAY;
function preload(){
...
if (frameCount%600===0){
diamond = createSprite(400,270,20,20);
...
if (frameCount%100===0){
strawberry = createSprite(400,290,20,20);  
